...
export default function IncidentDetailPage() {
  ...
  // Prevent hydration mismatch for time-sensitive values
  React.useEffect(() => {
    setMounted(true);
  }, []);
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{mounted ? Math.floor((Date.now() - new Date(incident.incident_date).getTime()) / 86400000) : "—"}</span>
                </div>
                <div className="flex justify-between">
