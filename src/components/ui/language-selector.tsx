...
// Module-level helper to set the locale cookie. Defined outside the
// component so React Compiler doesn't flag the document mutation.
function setLocaleCookie(code: SupportedLocale) {
